...
<#list o.datas.d1[1..] as onearray><#if onearray??><#assign len=onearray?size-1 /><#list 0..len as d><#if (d=4 || d=8)>${onearray[d]?date("yyyy-MM-dd")}<#else>${onearray[d]}</#if><#if d != len>,</#if></#list>
</#if></#list>
</#if>