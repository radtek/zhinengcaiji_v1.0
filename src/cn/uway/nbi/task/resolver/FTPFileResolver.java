 ...
 */
@IDMember(id = 201)
public class FTPFileResolver extends LocalFileResolver {

	private static final Logger LOG = LoggerFactory.getLogger(FTPFileResolver.class);
	...
	{
		private FTPFileDS ds;
		private String curDir;
		private Entry<String, FtpFileUnit> entity;
		private CountDownLatch latch;
		public FtpDownFile(FTPFileDS ds,String curDir,Entry<String, FtpFileUnit> entity,CountDownLatch latch)
		{
			this.ds = ds;
			this.curDir = curDir;
			this.entity = entity;
