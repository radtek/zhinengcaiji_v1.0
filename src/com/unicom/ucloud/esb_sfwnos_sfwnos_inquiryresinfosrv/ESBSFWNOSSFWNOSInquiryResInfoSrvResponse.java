...
/**
 * <p>
 * Java class for ESB_SFWNOS_SFWNOS_InquiryResInfoSrvResponse complex type.
 * <p>
 * The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ESB_SFWNOS_SFWNOS_InquiryResInfoSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_SFWNOS_SFWNOS_InquiryResInfoSrvOutputCollection" type="{http://ucloud.unicom.com/ESB_SFWNOS_SFWNOS_InquiryResInfoSrv}ESB_SFWNOS_SFWNOS_InquiryResInfoSrvOutputCollection" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_SFWNOS_SFWNOS_InquiryResInfoSrvResponse", propOrder = {"serviceflag", "servicemessage", "instanceid", "totalrecord",
		"totalpage", "pagesize", "currentpage", "esbsfwnossfwnosInquiryResInfoSrvOutputCollection"})
public class ESBSFWNOSSFWNOSInquiryResInfoSrvResponse {
	...
	@XmlElement(name = "ESB_SFWNOS_SFWNOS_InquiryResInfoSrvOutputCollection", nillable = true)
	protected List<ESBSFWNOSSFWNOSInquiryResInfoSrvOutputCollection> esbsfwnossfwnosInquiryResInfoSrvOutputCollection;
	...
	/**
	 * Gets the value of the esbsfwnossfwnosInquiryResInfoSrvOutputCollection property.
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be
	 * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the esbsfwnossfwnosInquiryResInfoSrvOutputCollection
	 * property.
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getESBSFWNOSSFWNOSInquiryResInfoSrvOutputCollection().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ESBSFWNOSSFWNOSInquiryResInfoSrvOutputCollection }
	 */
	public List<ESBSFWNOSSFWNOSInquiryResInfoSrvOutputCollection> getESBSFWNOSSFWNOSInquiryResInfoSrvOutputCollection() {
		if (esbsfwnossfwnosInquiryResInfoSrvOutputCollection == null) {
			esbsfwnossfwnosInquiryResInfoSrvOutputCollection = new ArrayList<ESBSFWNOSSFWNOSInquiryResInfoSrvOutputCollection>();
		}
		return this.esbsfwnossfwnosInquiryResInfoSrvOutputCollection;
	}
